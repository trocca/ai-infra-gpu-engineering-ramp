...
## The 12 weeks (start Mon 2026-08-10; onboarding Wed Aug 5 – Sun Aug 9)

| Wk | Dates | Prep | Study (2 h/day) | Build (4 h/day) | Why they pair |
|----|-------|------|-----------------|-----------------|---------------|
| 1 | Aug 10–14 | [prep](../companion-lessons/week-01.md) | NCA: AI/ML basics, GPU vs CPU, CUDA stack | autograd from scratch + Rust ramp | you study the stack while building backprop by hand |
| 2 | Aug 17–21 | [prep](../companion-lessons/week-02.md) | NCA: GPU hardware, NVLink, precision formats | CUDA-in-Rust kernels, memory hierarchy | morning theory = afternoon's coalescing experiments |
| 3 | Aug 24–28 | [prep](../companion-lessons/week-03.md) | NCA: networking, InfiniBand, DC design | SGEMM ladder vs cuBLAS | roofline thinking feeds both |
| 4 | Aug 31–Sep 4 | [prep](../companion-lessons/week-04.md) | NCA review + mock + **EXAM Fri Sep 4** | rusty-kernels → PyTorch (light Friday) | operations vocabulary meets custom ops packaging |
| 5 | Sep 7–11 | [prep](../companion-lessons/week-05.md) | GENL: LLM arch, prompting, data prep | GPT from scratch | the exam's architecture domain IS your build |
| 6 | Sep 14–18 | [prep](../companion-lessons/week-06.md) | GENL: fine-tuning, PEFT, evaluation | LoRA from scratch | study LoRA math, then implement it |
| 7 | Sep 21–25 | [prep](../companion-lessons/week-07.md) | GENL: optimization, quantization, TensorRT-LLM | Triton kernels + INT8 quant | quantization math becomes kernel evidence |
| 8 | Sep 28–Oct 2 | [prep](../companion-lessons/week-08.md) | GENL review + mock + **EXAM Fri Oct 2** | ferrum-serve (Rust/Candle engine, light Friday) | deployment/monitoring domains = your server's metrics |
| 9 | Oct 5–9 | [prep](../companion-lessons/week-09.md) | AIO: BCM, Slurm/K8s setup | distributed training internals (cloud 2×GPU) | NCCL transports appear in both, same week |
| 10 | Oct 12–16 | [prep](../companion-lessons/week-10.md) | AIO: Slurm admin, Run:ai, MIG | tensor + pipeline parallelism (cloud) | admin commands and parallelism both test resource boundaries |
| 11 | Oct 19–23 | [prep](../companion-lessons/week-11.md) | AIO: NGC, workloads, troubleshooting | K8s GPU serving: Operator, DCGM, KAI | the cert's lab drills and your deployment are the same commands |
| 12 | Oct 26–30 | [prep](../companion-lessons/week-12.md) | AIO lab drills + mock + **EXAM Fri Oct 30** | capstone: train→quantize→serve + repo polish | troubleshooting and portfolio defense converge |
